 ...
 * ==============================
 */
export const crearHorario = async (req: any, res: Response) => {
 ...
 * ==============================
 */
export const obtenerHorariosPorMateria = async (req: any, res: Response) => {
 ...
 * ==============================
 */
export const obtenerHorarioCompleto = async (req: any, res: Response) => {
  const id_usuario = req.usuario.id_usuario;
 ...
 * ==============================
 */
export const eliminarHorario = async (req: any, res: Response) => {
  const { id } = req.params;
  const id_usuario = req.usuario.id_usuario;
